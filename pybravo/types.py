...
Axis identifiers, head types, speed levels, and device state flags. The
numeric values match the constants the instrument firmware expects.
"""
...
class Axis(IntEnum):
    """Robot motion axes. Values match the firmware's axis constants."""
...
SAFE_HOME_ORDER: tuple[Axis, ...] = (Axis.Z, Axis.Zg, Axis.G, Axis.X, Axis.Y, Axis.W)
