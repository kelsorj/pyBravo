...
µL→mm factor all vary by the pipette head currently attached.
...
from pybravo.darwin.calibration import AxisCalibration
...
class WAxisHeadConfig:
    ...
    def calibration(self, calibration_offset: float = 0.0) -> AxisCalibration:
        # Set both HardwareMinimum/Maximum AND SoftwareMinimum/Maximum per
        # head type.
